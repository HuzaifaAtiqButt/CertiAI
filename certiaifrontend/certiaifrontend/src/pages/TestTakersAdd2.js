...
import styles from "./TestTakersAdd2.module.css";

const TestTakersAdd2 = () => {
  ...
  return (
    <div className={styles.testtakersAdd2}>
      ...
      <img
        className={styles.testtakersAdd2Child}
        alt=""
        src="/group-13342.svg"
      />
      ...
      <div className={styles.testtakersAdd2Item} />
      <div className={styles.testtakerHasBeenAddedWrapper}>
        <div className={styles.testtakerHasBeen}>TestTaker Has Been Added</div>
      </div>
      <div
        className={styles.testtakersAdd2Inner}
