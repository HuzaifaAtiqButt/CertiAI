...
import styles from "./InstructorRemove1.module.css";

const InstructorRemove1 = () => {
  const navigate = useNavigate();

  const onFrameContainerClick = useCallback(() => {
    navigate("/instructor-remove2");
  }, [navigate]);
  ...
  return (
    <div className={styles.instructorRemove1}>
      ...
      <img
        className={styles.instructorRemove1Child}
        alt=""
        src="/group-13342.svg"
      />
      <div className={styles.instructorRemove1Item} />
      <div className={styles.instructorWillBeRemovedParent}>
        <div className={styles.instructorWillBe}>
      ...
      <div className={styles.frameParent}>
        <div
          className={styles.yesRemoveInstructorWrapper}
          onClick={onFrameContainerClick}
        >
          <div className={styles.yesRemoveInstructor}>
      ...
      <div className={styles.vectorParent}>
        ...
        <div className={styles.vectorGroup} onClick={onGroupContainer3Click}>
