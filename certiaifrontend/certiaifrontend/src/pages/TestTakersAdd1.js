...
import styles from "./TestTakersAdd1.module.css";

const TestTakersAdd1 = () => {
  ...
  const onGroupContainer2Click = useCallback(() => {
    navigate("/testtakers-add2");
  }, [navigate]);

  return (
    <div className={styles.testtakersAdd1}>
      ...
      <img
        className={styles.testtakersAdd1Child}
        alt=""
        src="/group-13342.svg"
      />
      ...
      <div className={styles.testtakersAdd1Item} />
      <div className={styles.testtakersAdd1Inner} />
      ...
      <div className={styles.testtakersAdd1Child1} />
      <div className={styles.div}>9251466357</div>
      <div className={styles.welcomePooran}>Add TestTaker</div>
    </div>
  );
};

export default TestTakersAdd1;
