...
import styles from "./InstructorAdd2.module.css";
...
const InstructorAdd2 = () => {
  ...
  return (
    <div className={styles.instructorAdd2}>
      ...
      <img
        className={styles.instructorAdd2Child}
        alt=""
        src="/group-13342.svg"
      />
      <div className={styles.instructorAdd2Item} />
      <div className={styles.instructorHasBeenAddedWrapper}>
        <div className={styles.instructorHasBeen}>
          Instructor Has Been Added
        </div>
      </div>
      <div
        className={styles.instructorAdd2Inner}
