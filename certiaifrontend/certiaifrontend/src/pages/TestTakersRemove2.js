...
import styles from "./TestTakersRemove2.module.css";

const TestTakersRemove2 = () => {
  ...
  return (
    <div className={styles.testtakersRemove2}>
      ...
      <img
        className={styles.testtakersRemove2Child}
        alt=""
        src="/group-13342.svg"
      />
      ...
      <div className={styles.testtakersRemove2Item} />
      <div className={styles.testtakerHasBeenRemovedWrapper}>
        <div className={styles.testtakerHasBeen}>
          TestTaker Has Been Removed
        </div>
      </div>
      <div
        className={styles.testtakersRemove2Inner}
...
export default TestTakersRemove2;
